export const SOURCES = {
    apis: {
        primary: [
            { name: 'AniList', url: 'https://graphql.anilist.co', type: 'graphql' },
            { name: 'Jikan', url: 'https://api.jikan.moe/v4', type: 'rest' },
            { name: 'Kitsu', url: 'https://kitsu.io/api/edge', type: 'rest' },
            { name: 'SIMKL', url: 'https://api.simkl.com', type: 'rest' },
            { name: 'TMDB', url: 'https://api.themoviedb.org', type: 'rest' },
            { name: 'TVMaze', url: 'https://api.tvmaze.com', type: 'rest' },
            { name: 'Trakt', url: 'https://api.trakt.tv', type: 'rest' },
            { name: 'MyAnimeList', url: 'https://api.myanimelist.net', type: 'rest' },
        ],
        anime: [
            { name: 'AniAPI', url: 'https://api.aniapi.com', type: 'rest' },
            { name: 'TraceMoe', url: 'https://api.trace.moe', type: 'rest' },
            { name: 'AnimeChan', url: 'https://api.animechan.xyz', type: 'rest' },
            { name: 'AnimeThemes', url: 'https://api.animethemes.moe', type: 'rest' },
            { name: 'LiveChart', url: 'https://api.livechart.me', type: 'rest' },
            { name: 'AniChart', url: 'https://api.anichart.net', type: 'rest' },
            { name: 'Waifu.im', url: 'https://api.waifu.im', type: 'rest' },
        ],
        manga: [
            { name: 'MangaDex', url: 'https://api.mangadex.org', type: 'rest' },
            { name: 'Comick', url: 'https://api.comick.fun', type: 'rest' },
            { name: 'MAL Scraper', url: 'https://api.mal-scraper.herokuapp.com', type: 'rest' },
            { name: 'OtakuMode', url: 'https://api.otakumode.com', type: 'rest' },
        ],
        streaming: [
            { name: 'Crunchyroll API', url: 'https://api.crunchyroll.com', type: 'rest' },
            { name: 'Netflix', url: 'https://api.netflix.com', type: 'rest' },
            { name: 'Disney+', url: 'https://api.disneyplus.com', type: 'rest' },
            { name: 'Hulu', url: 'https://api.hulu.com', type: 'rest' },
            { name: 'Prime Video', url: 'https://api.primevideo.com', type: 'rest' },
        ],
    },
    rss: {
        news: [
