...
export async function fetchTVMazeShows() {
    try {
...
export async function fetchTraktShows() {
    try {
...
export async function fetchTMDBTV() {
    try {
        ...
        const data = await res.json();
        return (data.results || []).slice(0, 25).map((show) => ({
            title: show.name,
...
export async function fetchTMDBOnTheAir() {
    try {
        const apiKey = process.env.TMDB_API_KEY;
        if (!apiKey) {
            return [];
...
export async function fetchJikanTV() {
    try {
...
export async function fetchKitsuTV() {
    try {
...
export async function fetchAniListTV() {
    try {
        const query = `
      query {
        Page(perPage: 25) {
...
export async function fetchCrunchyrollSeries() {
    try {
        ...
        const data = await res.json();
        return (data.items || []).slice(0, 20).map((series) => ({
...
export async function fetchNetflixAnimeSeries() {
    try {
...
export async function fetchHIDIVESeries() {
    try {
...
export async function fetchVikiSeries() {
    try {
...
export async function fetchViuSeries() {
    try {
        ...
        const data = await res.json();
        return (data || []).slice(0, 20).map((series) => ({
            title: series.title,
...
export async function fetchMyDramaList() {
    try {
        ...
        const data = await res.json();
        return (data || []).slice(0, 20).map((drama) => ({
...
export async function crawlSeriesRSS() {
