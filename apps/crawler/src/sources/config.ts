export const SOURCES = {
  ...
  rss: {
    news: [
      { name: 'ANN', url: 'https://www.animenewsnetwork.com/all/rss.xml', category: 'news' },
      ...
      { name: 'Otaku Mode', url: 'https://otakumode.com/news/feed', category: 'news' },
      ...
      { name: 'AllTheAnime', url: 'https://blog.alltheanime.com/feed', category: 'news' },
      { name: 'Sakuga Blog', url: 'https://www.sakugablog.com/feed', category: 'news' },
      { name: '9TailedKitsune', url: 'https://9tailedkitsune.com/feed', category: 'news' },
      { name: '90s Anime', url: 'https://90sanime.com/feed', category: 'news' },
      ...
      { name: 'LiveChart', url: 'https://livechart.me/feeds', category: 'news' },
      { name: 'AniChart', url: 'https://anichart.net/feed', category: 'news' },
    ],
    manga: [
      { name: 'MangaDex', url: 'https://mangadex.org/rss', category: 'manga' },
      { name: 'Comick', url: 'https://comick.fun/rss', category: 'manga' },
      { name: 'Manga Bookshelf', url: 'https://mangabookshelf.com/feed', category: 'manga' },
      { name: 'Hi Wa Mata Noboru', url: 'https://hiwamatanoboru.com/feed', category: 'manga' },
      { name: 'Strawhat Manga', url: 'https://strawhatmanga.com/feed', category: 'manga' },
      { name: 'Romance Manga Recs', url: 'https://romancemangarecs.com/feed', category: 'manga' },
      { name: 'Dragneel Club', url: 'https://dragneelclub.com/feed', category: 'manga' },
    ],
    community: [
      { name: 'Reddit r/anime', url: 'https://www.reddit.com/r/anime/.rss', category: 'community' },
      { name: 'Reddit r/manga', url: 'https://www.reddit.com/r/manga/.rss', category: 'community' },
      { name: 'Reddit r/manhwa', url: 'https://www.reddit.com/r/manhwa/.rss', category: 'community' },
      { name: 'Reddit r/webtoons', url: 'https://www.reddit.com/r/webtoons/.rss', category: 'community' },
    ],
  },
...
export function getEnvConfig() {
  return {
    ...
    rss: [
      ...
      'https://blog.alltheanime.com/feed',
      'https://www.sakugablog.com/feed',
      'https://livechart.me/feeds',
      'https://anichart.net/feed',
      'https://mangadex.org/rss',
      'https://comick.fun/rss',
      'https://www.reddit.com/r/anime/.rss',
      'https://www.reddit.com/r/manga/.rss',
      'https://www.reddit.com/r/manhwa/.rss',
    ].join(','),
  };
}
